...
public class TestApp {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		List<String[]> customers = Utility.readFromAFile("customers.txt");
		...
		// and create a new Savings or Checking account based on the accountType and add that new Account to the List of Accounts
